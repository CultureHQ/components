...
function (_Component) {
  ...
  function ImageEditor() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleRotateRight", function () {
      _this.cropper.rotate(45);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleZoomIn", function () {
      _this.cropper.zoom(0.2);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleZoomOut", function () {
      _this.cropper.zoom(-0.2);
    });
