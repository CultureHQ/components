...
function (_Component) {
  ...
  function AsyncPath() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AsyncPath)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.state = {
      d: null
    }, _temp));
  }
