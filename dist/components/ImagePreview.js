...
function (_Component) {
  ...
  function ImagePreview() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ImagePreview)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(ImagePreview, [{
    ...
    value: function enqueueLoad() {
      ...
      var _this$containerRef$cu = this.containerRef.current.parentNode,
          clientWidth = _this$containerRef$cu.clientWidth,
          clientHeight = _this$containerRef$cu.clientHeight;
      return (0, _readImage.default)(image, preview, clientWidth, clientHeight).then(function (_ref) {
        var src = _ref.src,
            styles = _ref.styles;
