...
function (_Component) {
  ...
  function Nav() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Nav)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.state = {
      navDisplayed: true,
  ...
  _createClass(Nav, [{
    ...
    value: function getClassList() {
      ...
      return (0, _classnames.default)("chq-nav", {
