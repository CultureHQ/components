...
function (_Component) {
  ...
  function PageLink() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PageLink)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.handleClick = function () {
