...
* `onOffsetChange?` - a function that accepts one argument that represents the new offset corresponding to the new timezone
...
{{
  <Panel>
    <Panel.Body>
      <Form>
        <TimezoneField name="timezone" required>Timezone</TimezoneField>
      </Form>
    </Panel.Body>
  </Panel>
}}
