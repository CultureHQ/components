...
const Cheer = ({ className, color = "darkblue", pop }) => (
  ...
  >
    ...
    <circle class="chq-chr--fb chq-chr--fb-1" r="40" cy="0" cx="-24" />
    <circle class="chq-chr--fb chq-chr--fb-7" r="40" cy="0" cx="364" />
    <circle class="chq-chr--fb chq-chr--fb-2" r="40" cy="-54" cx="31" />
    <circle class="chq-chr--fb chq-chr--fb-6" r="40" cy="-54" cx="309" />
    <circle class="chq-chr--fb chq-chr--fb-3" r="40" cy="-86" cx="96" />
    <circle class="chq-chr--fb chq-chr--fb-5" r="40" cy="-86" cx="244" />
    <circle class="chq-chr--fb chq-chr--fb-4" r="40" cy="-101" cx="170" />
  </svg>
);
