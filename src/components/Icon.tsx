  ...
  render(): React.ReactElement {
    ...
    if (icon === "paint-bucket") {
      return (
        ...
        >
          <g>
            <path fill={color} d="m19.375 14.72s2.47 2.524 2.47 5.03c0 1.656-1.345 3-3 3-1.656 0-3-1.344-3-3 0-2.506 2.469-5.03 2.469-5.03.293-.293.768-.293 1.061 0z" />
            <path fill={color} d="m18.456 12.934-5.657 5.657c-.703.703-1.657 1.098-2.651 1.098-.995 0-1.949-.395-2.652-1.098l-4.242-4.242c-.703-.704-1.099-1.658-1.099-2.652 0-.995.396-1.949 1.099-2.652l6.363-6.363c.293-.293.768-.293 1.061 0l7.778 7.777c.683.684.683 1.792 0 2.475zm-1.061-1.06c.098-.098.098-.256 0-.354l-7.247-7.247-5.833 5.833c-.422.422-.66.994-.66 1.591s.238 1.169.66 1.591l4.242 4.242c.422.422.994.659 1.591.659.596 0 1.169-.237 1.591-.659z" />
            <path fill={color} d="m11.89 3.894c.293.293.293.768 0 1.061-.293.292-.768.292-1.061 0l-2.424-2.425c-.293-.292-.293-.768 0-1.06.293-.293.768-.293 1.061 0z" />
            <path fill={color} d="m2.905 10.947h15.313c.414 0 .75.336.75.75 0 .448-.171.896-.512 1.237l-5.657 5.657c-.703.703-1.657 1.098-2.651 1.098-.995 0-1.949-.395-2.652-1.098l-4.242-4.242c-.703-.704-1.099-1.658-1.099-2.652 0-.414.336-.75.75-.75z" />
          </g>
        </svg>
      );
    }
